    ...
    <>
        <div className='footer-box'>
            <div className='first-row'>
                <div className='Name'> Mealify </div>
            ...
            <div className='second-Row'>
              <div className='col'>
                  <div className='heading'>ABOUT Mealify</div>
                  <ul>
                    <li>Who We Are </li>
                    <li>Blog</li>
                    <li>Work With Us</li>
            ...
            <div className='third-row'>
              <div className='box'>
                <p>By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2024 © Mealify. All rights reserved.</p>
              </div>
            </div>
        </div>
    </>
